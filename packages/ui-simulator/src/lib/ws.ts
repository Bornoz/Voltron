...
/**
 * WebSocket client for the UI Simulator.
 * Registers as clientType: 'simulator'.
 */
export class SimulatorWebSocket {
  ...
  private scheduleReconnect(): void {
    ...
    const delay = Math.min(WS_RECONNECT_BASE * Math.pow(2, this.reconnectAttempts), WS_RECONNECT_MAX);
