export const tr = {
  ...
  agent: {
    ...
    sendingEdits: 'Degisiklikler yapay zekaya iletiliyor...',
    editsSent: 'Duzenlemeler gonderildi',
    aiApplying: 'Yapay zeka degisiklikleri uyguluyor...',
    sendFailed: 'Gonderim basarisiz',
    couldNotSendEdits: 'Degisiklikler gonderilemedi',
    filesCreated: 'dosya olusturuldu',
    filesProcessed: '{count} dosya islendi',
    workOnFile: 'Bu dosyada calis: {path}',
    ...
    mapWillActivate: 'Agent dosya islemleri basladiginda harita canlanir',
    gpsNavigation: 'GPS navigasyon haritasi',
    ...
    fixThisFile: 'Bu dosyayi duzelt',
    testThis: 'Bunun icin test yaz',
    refactorThis: 'Bu componenti refactor et',
    improveStyle: 'Stili iyilestir',
    continueCurrent: 'Mevcut goreve devam et',
    switchTask: 'Yeni goreve gec',
    reviewChanges: 'Yapilan degisiklikleri incele',
    ...
    gps: {
      ...
      setBreakpointDesc: 'Agent bu dosyaya gelince duraklat',
      removeBreakpoint: 'Breakpoint Kaldir',
      removeBreakpointDesc: 'Dosyadaki durdurma noktasini kaldir',
      improveFileDesc: 'Agent\'tan bu dosyayi iyilestirmesini iste',
  ...
  commandPalette: {
    ...
    layoutMinimal: 'Minimal Yerlesim',
    layoutDevelopment: 'Gelistirme Yerlesimi',
    layoutReset: 'Yerlesimi Sifirla',
    recent: 'Son Kullanilanlar',
    injectFix: 'Inject: Mevcut dosyayi duzelt',
    injectExplain: 'Inject: Bu kodu acikla',
  ...
  tour: {
    ...
    close: 'Basla',
    step1Title: 'Interaktif Demo',
    step1Desc: 'Kurulum gerekmez! Feed sekmesinde "Try Demo" butonuna tiklayarak 14 kurallik risk motorunun dosya islemlerini gercek zamanli siniflandirmasini izleyin. Sifir AI token tuketir.',
    step2Title: 'Hizli Prompt Bar',
    step2Desc: 'Alttaki prompt cubugu ile hizlica agent baslatabilir veya oturum ortasinda talimat enjekte edebilirsiniz. Ctrl+Enter ile gonderin. Hizli aksiyon cip\'leri yaygin gorevler icin tek tik saglar.',
    step3Title: 'Agent Calisma Alani',
    step3Desc: 'Ana calisma alaniniz. AI agent\'i baslatir, izler ve yonetirsiniz. Prompt enjeksiyonu, faz takibi, GPS navigasyonu ve cikti panelleri Agent sekmesinden erisilebilinir.',
    step4Title: 'Koruma Bolgeleri',
    step4Desc: 'Kritik dosyalari DO_NOT_TOUCH olarak isaretleyerek tehlikeli degisiklikleri engelleyin. Risk motoru koruma bolgelerini ihlal eden islemleri otomatik isaretler.',
    step5Title: 'GPS Navigasyon Haritasi',
    step5Desc: 'Agent\'in dosya sisteminde nerede calistigini gercek zamanli gorsellestirir. Isi haritasi, zoom, pan ve breakpoint ozellikleri iceren interaktif harita.',
    step6Title: 'Gorsel Editor ve Referans Tasarim',
    step6Desc: 'Canli onizleme ile dogrudan UI uzerinde duzenleme yapin. Bir referans tasarim ekran goruntusu yukleyin ve AI\'nin benzer bilesenler uretmesini saglayin. Sag tik menusunden 30+ secenek.',
    step7Title: 'Klavye Kisayollari',
    step7Desc: 'Ctrl+K ile komut paletini acin, ? ile tum kisayollari gorun. Bosluk tusuna basarak agent\'i hizla duraklatip devam ettirebilirsiniz.',
  },
  ...
  gettingStarted: {
    title: 'Baslarken',
    dismiss: 'Kapat',
    tryDemo: 'Interaktif Demoyu Dene',
    tryDemoDesc: 'Risk motorunun dosya islemlerini nasil siniflandirdigini gercek zamanli gorun.',
    startDemo: 'Demo Baslat',
    spawnAgent: 'Ilk Agent\'ini Baslat',
    spawnAgentDesc: 'Claude\'a bir gorev ver ve Voltron\'un her dosya degisikligini izlemesini izle.',
    spawnAgentBtn: 'Agent Baslat',
    setupZones: 'Koruma Bolgeleri Olustur',
    setupZonesDesc: 'Kritik dosyalari DO_NOT_TOUCH olarak isaretleyerek tehlikeli degisiklikleri engelleyin.',
    customize: 'Kurulumunu Ozellestir',
    customizeDesc: 'Varsayilan model, dil ve bildirim tercihlerini ayarla.',
    openSettings: 'Ayarlari Ac',
  },

  // Live Preview
  livePreview: {
    loadFailed: 'Preview yuklenemedi',
    unsupportedType: 'Bu dosya turu onizlenemez',
    useCodeView: '{ext} dosyalari icin kod gorunumunu kullanin',
  ...
  gpsFilePreview: {
    changes: 'degisiklik',
    files: 'dosya',
    clearFileTooltip: 'Bu dosyanin degisikliklerini temizle',
    clearAll: 'Tumunu Temizle',
    sendAllToAI: 'Tumunu AI\'ye Gonder',
    editTextTitle: 'Metin Duzenle',
    newContentLabel: 'Yeni icerik',
    newContentPlaceholder: 'Yeni metin giriniz...',
    ctrlEnterHint: 'Ctrl+Enter ile hizlica uygulayabilirsiniz',
    cancel: 'Iptal',
    apply: 'Uygula',
    confirmCancel: 'Vazgec',
    confirmOk: 'Onayla',
    changesSent: '{count} degisiklik AI\'ye gonderildi',
    historyCleared: 'Degisiklik gecmisi temizlendi',
    askAIPrompt: 'Bu element hakkinda yardim istiyorum:\\n{elementInfo}\\nSelector: {selector}\\nDosya: {filePath}',
    styleApplied: 'Stil uygulandı',
    textUpdated: 'Metin guncellendi',
    elementDeleted: 'Element silindi',
    elementDuplicated: 'Element kopyalandi',
    visibilityToggled: 'Gorunurluk degistirildi',
    visits: 'ziyaret',
    live: 'Canli',
    historyTooltip: 'Aktivite gecmisi',
    minimizeTooltip: 'Kucult',
    maximizeTooltip: 'Tam ekran',
    closeTooltip: 'Kapat (Esc)',
    activity: 'Aktivite',
    designModeHint: 'Sag tikla: Tasarim modu',
    changesCount: '{count} degisiklik',
    totalChanges: 'toplam {total} ({fileCount} dosya)',
    clearFileChanges: 'Bu dosyanin degisikliklerini temizle',
    sendAllToAITooltip: 'Tum dosyalardaki degisiklikleri AI\'ye gonder',
    sendToAI: 'AI\'ye Gonder',
    escCloseHint: 'Esc: Kapat',
    deleteElementTitle: 'Elementi Sil',
    deleteElementMessage: 'Bu element DOM\'dan tamamen kaldirilacak. Bu islem geri alinamaz. Devam etmek istiyor musunuz?',
  },
  ...
  designMenu: {
    content: 'Icerik',
    contentDesc: 'Metin, font, hizalama',
    appearance: 'Gorunum',
    appearanceDesc: 'Renk, opaklık, cerceve',
    layout: 'Yerlesim',
    layoutDesc: 'Flex, grid, bosluk',
    effects: 'Efektler',
    effectsDesc: 'Golge, blur, animasyon',
    structure: 'Yapi',
    structureDesc: 'Kopyala, sil, sifirla',
    red: 'Kirmizi',
    orange: 'Turuncu',
    yellow: 'Sari',
    green: 'Yesil',
    ...
    up: 'Yukari',
    blueGlow: 'Mavi Glow',
    greenGlow: 'Yesil Glow',
    purpleGlow: 'Mor Glow',
    redGlow: 'Kirmizi Glow',
    editText: 'Metni Duzenle',
    editTextDesc: 'Secili elementin ic metnini premium editor ile degistir.',
    boldLabel: 'Kalin Yazi',
    boldDesc: 'Font kalinligini bold/normal arasinda toggle et.',
    italicLabel: 'Italik',
    italicDesc: 'Yaziyi italik/normal arasinda toggle et.',
    underlineLabel: 'Alti Cizili',
    underlineDesc: 'Yazi altina cizgi ekle veya kaldir.',
    fontIncrease: 'Yazi Boyutu +2px',
    fontIncreaseDesc: 'Mevcut: {size} → artir.',
    fontDecrease: 'Yazi Boyutu -2px',
    fontDecreaseDesc: 'Mevcut: {size} → azalt.',
    alignLeft: 'Sola Hizala',
    alignCenter: 'Ortala',
    alignRight: 'Saga Hizala',
    textColor: 'Yazi Rengi',
    textColorDesc: 'Mevcut: {color}. Genis renk paletinden sec.',
    bgColor: 'Arka Plan Rengi',
    bgColorDesc: 'Mevcut: {color}. Renk sec.',
    borderColor: 'Cerceve Rengi',
    opacityUp: 'Opaklik +10%',
    opacityUpDesc: 'Elementin gorununurluk yogunlugunu artir.',
    opacityDown: 'Opaklik -10%',
    opacityDownDesc: 'Elementi daha seffaf yap. Katmanli tasarim icin.',
    borderRadiusAdd: 'Koseleri Yuvarla +4px',
    borderRadiusAddDesc: 'Mevcut: {radius}. Daha yumusak koseler.',
    borderRadiusRemove: 'Koseleri Duzlestir',
    borderAdd: 'Cerceve Ekle',
    border2px: 'Kalin Cerceve',
    borderRemove: 'Cerceveyi Kaldir',
    displayFlexDesc: 'Cocuk elementleri yan yana diz. display:flex.',
    displayGridDesc: 'CSS Grid sistemi aktif et. display:grid.',
    displayBlock: 'Blok',
    displayBlockDesc: 'display:block — her element yeni satirda.',
    displayInlineFlex: 'Inline Flex',
    displayNone: 'Gizle',
    displayNoneDesc: 'display:none ile elementi tamamen gizle.',
    centerFlex: 'Flex ile Ortala',
    flexColumn: 'Flex Dikey',
    flexColumnDesc: 'flex-direction: column — elementleri alt alta diz.',
    flexBetween: 'Flex Space-Between',
    flexBetweenDesc: 'Elementleri esit aralikla diz.',
    gapAdd: 'Gap +8px',
    gapAddDesc: 'Flex/Grid elemanlar arasi bosluk artir.',
    paddingAdd: 'Padding +8px',
    paddingAddDesc: 'Mevcut: {padding}. Ic bosluk artir.',
    paddingRemove: 'Padding -8px',
    marginAdd: 'Margin +8px',
    marginAddDesc: 'Mevcut: {margin}. Dis bosluk artir.',
    width100: 'Tam Genislik',
    width100Desc: 'width: 100% — tum genisligi kapla.',
    positionRelative: 'Position: Relative',
    positionRelativeDesc: 'Akis icerisinde kaydirmaya izin verir.',
    positionAbsolute: 'Position: Absolute',
    positionAbsoluteDesc: 'Parent elementa gore serbest konumlandirma.',
    overflowHidden: 'Overflow Hidden',
    overflowHiddenDesc: 'Tasmis icerigi gizle.',
    shadowPresets: 'Golge Preset\'leri',
    shadowPresetsDesc: '12 hazir golge efekti. Glow, neon, premium...',
    animationPresets: 'Animasyon Preset\'leri',
    animationPresetsDesc: 'Fade, slide, bounce, pulse, spin...',
    blurAdd: 'Bulaniklastir',
    blurAddDesc: 'filter: blur(4px) — arka plan icin glassmorphism.',
    blurRemove: 'Bulanikligi Kaldir',
    blurRemoveDesc: 'filter: none — netligi geri getir.',
    backdropBlur: 'Backdrop Blur',
    backdropBlurDesc: 'Arka plani bulaniklastir. Cam efekti.',
    transitionSmooth: 'Gecis: Smooth (0.3s)',
    transitionSmoothDesc: 'transition: all 0.3s ease — yumusak gecis.',
    transitionSpring: 'Gecis: Spring (0.5s)',
    transitionSpringDesc: 'Yay efektli gecis animasyonu.',
    scaleUp: 'Buyut (%110)',
    scaleUpDesc: 'transform: scale(1.1) — elementi buyut.',
    rotate5: 'Dondur 5 derece',
    rotate5Desc: 'transform: rotate(5deg) — hafif yana yatir.',
    transformReset: 'Transform Sifirla',
    transformResetDesc: 'transform: none — normal boyut ve pozisyona dondur.',
    gradientPresets: 'Gradient Preset\'leri',
    gradientPresetsDesc: '10 hazir gradient. Gunes batimi, okyanus, neon...',
    glassmorphism: 'Glassmorphism',
    glassmorphismDesc: 'Cam efekti: seffaf bg + backdrop-blur + ince border.',
    glassDark: 'Glass Dark',
    glassDarkDesc: 'Koyu glassmorphism: karanlik seffaf cam efekti.',
    neumorphism: 'Neumorphism',
    neumorphismDesc: 'Kabartma efekti: ic ve dis golge kombinasyonu.',
    neonBorder: 'Neon Border',
    neonBorderDesc: 'Isildayan neon cerceve efekti.',
    neonText: 'Neon Text',
    neonTextDesc: 'Yaziyi isildayan neon efekti ile goster.',
    frostedCard: 'Frosted Card',
    frostedCardDesc: 'Premium kart stili: glassmorphism + golge + radius.',
    hoverLift: 'Hover Lift Efekti',
    hoverLiftDesc: 'Hover\'da yukselme: translateY + shadow artisi.',
    duplicate: 'Kopyala',
    duplicateDesc: 'Elementi birebir kopyalayip hemen sonrasina yerlestir.',
    toggleVisibility: 'Gorunurlugu Toggle',
    toggleVisibilityDesc: 'Elementi goster/gizle (display none ↔ block).',
    deleteElement: 'Elementi Sil',
    deleteElementDesc: 'DOM\'dan tamamen kaldir. Onay istenir.',
    resetStyles: 'Tum Stilleri Sifirla',
    resetStylesDesc: 'Bu elemente yapilan tum CSS degisikliklerini geri al.',
    askAI: 'AI\'ya Sor',
    askAIDesc: 'Bu element hakkinda AI\'ya soru sor veya degisiklik iste.',
    undoTitle: 'Geri Al (Ctrl+Z)',
    undoLabel: 'Geri Al',
    textColorLabel: 'Yazi Rengi',
    bgColorLabel: 'Arka Plan',
    borderColorLabel: 'Cerceve Rengi',
    selectedColor: 'Secili renk',
    applyColor: 'Rengi Uygula',
    gradientPanelTitle: 'Gradient Preset\'leri',
    customGradient: 'Ozel Gradient (CSS)',
    shadowPanelTitle: 'Golge Preset\'leri',
    customShadow: 'Ozel Shadow (CSS)',
