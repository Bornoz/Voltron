...
import { PromptInjector } from './components/Agent/PromptInjector';
        ...
        <div className="space-y-2 p-2 border-b border-gray-800">
          ...
          {agentStatus !== 'IDLE' && agentStatus !== 'COMPLETED' && agentStatus !== 'CRASHED' && (
            <>
              ...
              <div className="px-1">
                <div className="text-[10px] text-gray-500 uppercase tracking-wider mb-1">{t('agent.promptInjector')}</div>
                <PromptInjector projectId={projectId} onInject={handleAgentInject} />
              </div>
            </>
          )}
        </div>
